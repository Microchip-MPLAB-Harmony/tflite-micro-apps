...
/*******************************************************************************
  ...
  Remarks:
    See prototype in app_gfx_e70.h.
 */

void APP_GFX_E70_Initialize ( void )
{
    /* Place the App state machine in its initial state. */
    app_gfxData.state = APP_GFX_E70_STATE_INIT;
    ...
    switch ( app_gfxData.state )
    {
        ...
        case APP_GFX_E70_STATE_INIT:
        {
            ...
            if (appInitialized)
            {
                ...
                app_gfxData.state = APP_GFX_E70_STATE_SERVICE_TASKS;
            }
            break;
        }

        case APP_GFX_E70_STATE_SERVICE_TASKS:
        {
