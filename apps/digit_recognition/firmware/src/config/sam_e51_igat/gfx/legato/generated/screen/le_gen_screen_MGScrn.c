...
leResult screenInit_MGScrn(void)
{
    ...
    MGScrn_PanelWidget3->fn->setPosition(MGScrn_PanelWidget3, 424, 47);
    MGScrn_PanelWidget3->fn->setSize(MGScrn_PanelWidget3, 56, 273);
    ...
    MGScrn_PanelWidget2->fn->setPosition(MGScrn_PanelWidget2, 59, 271);
    MGScrn_PanelWidget2->fn->setSize(MGScrn_PanelWidget2, 413, 49);
    ...
    MGScrn_PanelWidget1->fn->setPosition(MGScrn_PanelWidget1, 60, 0);
    MGScrn_PanelWidget1->fn->setSize(MGScrn_PanelWidget1, 420, 58);
    ...
    MGScrn_PanelWidget0->fn->setSize(MGScrn_PanelWidget0, 205, 320);
    ...
    MGScrn_DrawSurfaceWidget0->fn->setPosition(MGScrn_DrawSurfaceWidget0, 200, 50);
    ...
    MGScrn_GestureImageWidget->fn->setPosition(MGScrn_GestureImageWidget, 200, 50);
    ...
    MGScrn_DrawInstructionLabel->fn->setPosition(MGScrn_DrawInstructionLabel, 200, 10);
    MGScrn_DrawInstructionLabel->fn->setSize(MGScrn_DrawInstructionLabel, 200, 30);
    ...
    MGScrn_LabelWidget0->fn->setPosition(MGScrn_LabelWidget0, 23, 77);
    ...
    MGScrn_ImageWidget1->fn->setPosition(MGScrn_ImageWidget1, 45, 120);
